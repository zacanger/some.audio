...
const isJson = require('zeelib/lib/is-json').default
  ...
  app.listen(port, () => {
    const clusterMessage =
      process.env.NODE_ENV === 'production'
        ...
        : ''
    pino.info(
      `${packageName} version ${version} ${clusterMessage}listening on ${port}`
    )
  })
}

const tryJson = (a) => (isJson(a) ? JSON.stringify(a) : a)
