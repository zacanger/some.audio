...
module.exports = () =>
  layout(`
    <div>
      ...
      <!-- NOTE: closure notice, remove if you're forking -->
      <h1>Closure Notice</h1>
      <p>
        some.audio will be going down by September 2020.
        I recommend using Vocaroo or some other service.
        Uploads have now been disabled. Your links will
        keep working for now. It's been fun. Feel free
        to grab the code and spin up your own copy.
      </p>
